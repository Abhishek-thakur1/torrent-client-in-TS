...
let message = function (messageID: any) {
    this.messageID = messageID || -3;
} as any as { new (txt: any): any };


// parse
module.exports.parse = function (msg: any) {
...
module.exports.handshake = function(torrent: any) {
...
module.exports.request = function(pieceIndex:number, requestLength: number, offset: number) {
